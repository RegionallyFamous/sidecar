...
- `.os-window__slot--after-titlebar` hosts the companion's always-visible `<os-select class="os-editor-sidecar-panel-select" label="Sidebar panel">`. Its current value tracks the selected complementary-area id.
